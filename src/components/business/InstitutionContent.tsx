...
export const InstitutionContent: React.FC<InstitutionContentProps> = ({
  ...
  return (
    <>
          ...
          <div className="bg-white rounded-3xl shadow-lg p-8 md:p-12">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <div className="text-4xl font-bold text-green-600 mb-2">{rates.desde}</div>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <div className="text-4xl font-bold text-green-600 mb-2">{rates.hasta}</div>
                <div className="text-global-6">Mes vencido</div>
      ...
      <Section className="py-16">
        <div className={`max-w-4xl mx-auto text-center bg-gradient-to-r ${gradientColors.from} ${gradientColors.to} rounded-3xl p-12 text-white`}>
          <h2 className="text-3xl font-bold mb-4">
            ¿Listo para solicitar tu crédito?
          </h2>
          <p className={`${gradientColors.from.replace('from-', '')}-100 text-lg mb-8 max-w-2xl mx-auto`}>
          ...
          <button className="bg-white text-gray-700 px-8 py-4 rounded-xl font-semibold hover:bg-gray-50 transition-colors duration-200 shadow-lg">
