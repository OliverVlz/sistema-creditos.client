...
export const ArmadaHero: React.FC = () => {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            <div className="flex items-center justify-center lg:justify-start gap-4 mb-6">
              <img
                src={armadaImage}
                alt="Escudo de la Armada Nacional"
              ...
              <div>
                ...
                <p className="text-blue-100 text-lg">Poder Naval Colombiano</p>
              </div>
            </div>

            <p className="text-blue-50 text-lg leading-relaxed mb-8 max-w-2xl">
              La fuerza naval de Colombia, responsable de la defensa de las costas,
              ríos y mares territoriales, y el mantenimiento de la soberanía marítima.
            </p>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-4">
              ...
              <button className="border-2 border-white text-white px-8 py-3 rounded-xl font-semibold hover:bg-white hover:text-blue-800 transition-all duration-200">
                Conocer Más
              </button>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="relative bg-white/10 backdrop-blur-sm rounded-3xl p-8 shadow-2xl">
              <img
                src={armadaImage}
                alt="Armada Nacional de Colombia"
              ...
              <div className="absolute -top-4 -left-4 bg-white/90 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                ...
                <div className="text-sm text-gray-600">Buques</div>
              </div>

              <div className="absolute -bottom-4 -right-4 bg-white/90 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                <div className="text-2xl font-bold text-blue-800">15K+</div>
                <div className="text-sm text-gray-600">Marinos</div>
              </div>
            </div>
          </div>
        </div>
